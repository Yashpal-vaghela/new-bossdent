...
export const ServiceSection = () => {
    return (
        <section className="contact-link-section mb-4 mt-2 mt-lg-5">
        <div className="container">
          <div className="row">
            <div className="contact-content-wrapper mb-1 mb-sm-3 mb-md-0 col-lg-3 col-md-6  col-6 d-flex justify-content-center align-items-center">
              <img
