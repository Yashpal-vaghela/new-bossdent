    ...
    return (
        <>
            <Routes>
                ...
                <Route path="/checkout" element={<ProtectedOrderRoute><Checkout></Checkout></ProtectedOrderRoute>}></Route>
                ...
                <Route path="/order-history/:id" element={<ProtectedRoute><OrderHistory></OrderHistory></ProtectedRoute>}></Route>
