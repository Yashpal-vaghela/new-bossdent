...
const ContactSchema = yup.object().shape({
    ...
    email:yup.string().email("Please Enter Vaild email").required("Email field is required."),
                    ...
                    <div className="row pt-2 pb-4 gap-3 gap-sm-0">
                        ...
                        <div className="col-lg-6">
                            <div className="contact-details-content">
                                ...
                                <p className="text-center">Fill in the below form and we will get in touch with you as soon as possible.</p>

                                <form className='form contact-form' onSubmit={formik?.handleSubmit}>
                                    <div className={`${formik?.errors.name ? "my-3" : "mb-4"}`}>
                                        <input className="form-control" type="text" name="name" placeholder='Name' value={formik?.values.name || ""} onChange={formik.handleChange} onBlur={formik?.handleBlur}></input>
                                        {
                                            formik?.errors?.name && (
                                    ...
                                    <div className={`${formik?.errors?.email ? "my-3" : "mb-4"}`}>
                                        <input className="form-control" type="text" name="email" placeholder='E-mail' value={formik?.values.email || ""}  onChange={formik?.handleChange} onBlur={formik?.handleBlur}></input>
                                        {
                                            formik?.errors?.email && (
                                    ...
                                    <div className={`${formik?.errors?.phone ? "my-3" : "mb-4"}`}>
                                        <input className='form-control' type="number" placeholder='Phone' name="phone" value={formik?.values.phone || ""} onChange={formik?.handleChange} onBlur={formik?.handleBlur}></input>
                                        {
                                            formik?.errors?.phone && (
                                    ...
                                    <div className={`${formik?.errors?.subject ? "my-3" : "mb-4"}`}>
                                        <input className="form-control" type="text" name="subject" placeholder='Subject' value={formik?.values.subject || ""}  onChange={formik?.handleChange} onBlur={formik?.handleBlur}></input>
                                        {
                                    ...
                                    <div className={`${formik?.errors?.message ? "my-3" : "mb-4"}`}>
                                        <textarea className="form-control" type="text" name="message" placeholder='Message' rows="3" value={formik?.values.message || ""} onChange={formik?.handleChange} onBlur={formik?.handleBlur}></textarea>
                                        {/* <input className="form-control" type="text" name="message" placeholder='Subject' value={formik?.values.message || ""}  onChange={formik?.handleChange} onBlur={formik?.handleBlur}></input> */}
                                        {
                    ...
                    <div className="contact-info-wrapper d-flex justify-content-between row text-white mt-4 mt-md-4 pb-md-5 pb-3">
                        <div className="contact-info-email contact-link-wrapper col-lg-3 col-md-6 col-12">
                            <div className="email-icon contact-info-icon">
                                <img src="/img/email-icon.svg" alt="email-icon" className="img-fluid"></img>
                            </div>
                            <p>Email</p>
                            <Link to="mailto:zahndentaldepo@gmail.com">zahndentaldepo@gmail.com</Link>
                        </div>
                        <div className="contact-info-location contact-link-wrapper col-lg-5 col-md-6 col-12">
                            <div className="contact-info-icon">
                                <img src="/img/location-icon.svg" alt="location-icon" className="img-fluid"></img>
                            </div>
                            <p>Location</p>
                            <span className="text-center d-block">Plot No. 1 to 8, Marutidham Industrial Estate, Behind Hotel Royal, Velanja Road, Umra, Surat-394130, Gujarat</span>
                        </div>
                        <div className="contact-info-contact contact-link-wrapper col-lg-3 col-md-6 col-12">
                            <div className="contact-info-icon">
                                <img src="/img/grident-call-icon.svg" alt="call-icon" className='img-fluid'></img>
                            </div>
                            <p>Phone</p>
