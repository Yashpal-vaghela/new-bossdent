...
export const RefundPolicy = () => {
  ...
  return (
    <div className="home-main pt-0 pt-lg-0 pb-2">
      ...
      <div className="container mb-4 mb-sm-5">
        <div className="refund-policy-wrapper">
          <ul>
            <li className="refund-heading">Refund and Returns Policy</li>
          </ul>
          ...
          <ul>
            <li>
              The refund processing time will be depend on the payment method
              and finance department.The refund is processed by us, it may take
              10 to 15 business days for the funds to appear in your account.
            </li>
          </ul>
          <h2>5. Contact us</h2>
          <ul>
            <li>
              If you have any questions, or concerns, or need assistance with
              our Refund and Returns Policy, please contact our customer support
              team through the designated communication channels mentioned on
              our website. We are here to help you and ensure your satisfaction.
            </li>
            <li>
              Please note that this policy is subject to change without prior
              notice. It is your responsibility to review the policy
