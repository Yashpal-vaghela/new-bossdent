    ...
    <div className="home-main pt-4">
        ...
        <div className="container">
          <div className="row align-items-center justify-content-center">
            ...
            <div className="col-lg-6">
                ...
                <p>We are a premium dental supply brand dedicated to supporting dentists with reliable, professional-grade essentials. At our core, we believe the right supplies are not just tools, but the very foundation of confident care.</p>
      ...
      <section className="dental-supply-info-section ">
        <div className="container">
          ...
          <p>Every product we deliver is selected to meet the standards of professional dentistry, helping clinics run without interruption and patients receive care with confidence At Bossdent, we don’t just supply items — we deliver the assurance that every detail of your practice is backed by dependable support.</p>
        </div>
      </section>
      <section className="trusted-section">
        <div className="container">
            <h2 className="aboutSection-title">Trusted by Professionals</h2>
            <p className="aboutSection-subtitle">Dentists across India trust us because we deliver more than just supplies — we deliver confidence and consistency. Here’s why Bossdent stands out</p>
            <ul>
                <li>Trusted Quality – Every product goes through strict checks to ensure consistent quality and reliability, so dentists never have to worry about performance or safety</li>
                <li>Nationwide Reach – With reliable nationwide distribution, we deliver quickly and efficiently — ensuring every clinic has dependable access to essential supplies.</li>
                <li>Affordable Solutions – We offer affordable solutions without compromise, giving dentists access to professional quality at fair prices.</li>
                <li>Dentist-Centric Approach – We understand the unique needs of dental practices and design our solutions to make daily clinical work smoother, safer, and stress-free.</li>
                <li>Proven Experience – Since 2022, we’ve consistently supported clinics nationwide — earning trust through reliability and long-term commitment.</li>
                <li>Consistency & Trust – Dentists choose us because we keep our promises — giving every order, big or small, the same care and attention.</li>
            </ul>
            <div className="row align-items-center justify-content-between contact-info-section">
                ...
                <div className="col-lg-6">
                    <p>Plot No. 1 to 4, Ground Floor, Marutidham Industrial Estate Behind Hotel Royal, Velanja Road, Umra, Surat - 394130, Gujarat, India</p>
                </div>
                <div className="col-lg-3 pb-2 pb-lg-0">
                    <Link to="tel:+917698828883">+91 76988 28883</Link>
                </div>
                <div className="col-lg-3 pb-2 pb-lg-0">
                    <Link to="mailto:zahndentaldepo@gmail.com">bossdentindia@gmail.com</Link>
                </div>
            </div>
        </div>
      </section>
